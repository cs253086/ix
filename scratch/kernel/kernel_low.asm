...
%define MESSAGE_SIZE	4 + 4 + 64 + 64 + (4 * 16) + (4 * 16)
...
SECTION .text
	global sys_call_low, run_proc, cp_msg_low, phy_copy, kernel_stack_saved, switch_paging, wait_for_interrupt
...
run_proc:
	...
	; load register values from process table[cur_proc_id] to registers 
	...
	pop	es
	pop	ds
	; save tmp_cs, tmp_psw, tmp_esp, tmp_eip for iret
	pop	dword [tmp_cs]
	pop	dword [tmp_psw]
	pop	dword [tmp_eip]
	popad	;esp value is ignored
	; save esp manually to tmp_esp
