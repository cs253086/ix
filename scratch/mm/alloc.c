...
void dellocate_process_hole(mm_proc_t *mm_proc)
{
debug_printf("dellocate_process_hole\n");
	int process_hole_idx = (mm_proc->pid) - (PID_INIT + 1);
	add_last(&process_holes[process_hole_idx]);
