...
#define BASE            1536	/* address where MINIX starts in memory - p.92*/
...
/* Start the ball rolling. */
  ...
  phys_bytes phys_b;
/* extern is to declare only, not define. http://www.geeksforgeeks.org/archives/840 */
  ...
  lock();			/* we can't handle interrupts yet - clear interrupt flag(set to 0)*/
